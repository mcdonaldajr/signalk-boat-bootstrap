...
AIS_PLUS_VERSION="${AIS_PLUS_VERSION:-v6.1.10}"
AIS_PLUS_AUDIO_VERSION="${AIS_PLUS_AUDIO_VERSION:-v0.3.11}"
AIS_PLUS_COMPANION_VERSION="${AIS_PLUS_COMPANION_VERSION:-v1.2.1}"
AIS_PLUS_APPLE_WATCH_VERSION="${AIS_PLUS_APPLE_WATCH_VERSION:-v0.1.0}"
