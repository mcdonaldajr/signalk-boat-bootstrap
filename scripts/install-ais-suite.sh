...
WATCHKEEPER_CONSOLE_VERSION="${WATCHKEEPER_CONSOLE_VERSION:-v0.3.8}"
NOTIFICATIONS_PLUS_VERSION="${NOTIFICATIONS_PLUS_VERSION:-v1.0.4}"
WATCHKEEPER_ALERTS_VERSION="${WATCHKEEPER_ALERTS_VERSION:-v0.1.0}"
...
INSTRUMENTS_PLUS_VERSION="${INSTRUMENTS_PLUS_VERSION:-v1.2.1}"
...
PI_CONTROLLER_VERSION="${PI_CONTROLLER_VERSION:-v1.2.1}"

PIPER_VERSION="${PIPER_VERSION:-v1.2.1}"
