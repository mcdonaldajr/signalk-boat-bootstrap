...
WATCHKEEPER_DISPLAY_VERSION="${WATCHKEEPER_DISPLAY_VERSION:-v2.2.13}"
WATCHKEEPER_CONSOLE_VERSION="${WATCHKEEPER_CONSOLE_VERSION:-v0.3.15}"
NOTIFICATIONS_PLUS_VERSION="${NOTIFICATIONS_PLUS_VERSION:-v1.0.4}"
WATCHKEEPER_ALERTS_VERSION="${WATCHKEEPER_ALERTS_VERSION:-v0.1.1}"
AIS_PLUS_AUDIO_VERSION="${AIS_PLUS_AUDIO_VERSION:-v2.3.16}"
...
CAPTURE_PLUS_VERSION="${CAPTURE_PLUS_VERSION:-v1.2.3}"
VOYAGE_CAPTURE_VERSION="${VOYAGE_CAPTURE_VERSION:-v0.1.14}"
VOYAGE_VIEWER_VERSION="${VOYAGE_VIEWER_VERSION:-v0.1.13}"
VESSEL_DATABASE_VERSION="${VESSEL_DATABASE_VERSION:-v1.0.0}"
HARBOUR_EDITOR_VERSION="${HARBOUR_EDITOR_VERSION:-v3.1.0}"
