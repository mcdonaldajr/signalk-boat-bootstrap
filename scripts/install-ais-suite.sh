...
AIS_PLUS_VERSION="${AIS_PLUS_VERSION:-v6.1.11}"
AIS_PLUS_AUDIO_VERSION="${AIS_PLUS_AUDIO_VERSION:-v0.3.13}"
AIS_PLUS_COMPANION_VERSION="${AIS_PLUS_COMPANION_VERSION:-v1.2.8}"
AIS_PLUS_APPLE_WATCH_VERSION="${AIS_PLUS_APPLE_WATCH_VERSION:-v0.1.4}"
CAPTURE_PLUS_VERSION="${CAPTURE_PLUS_VERSION:-v0.2.15}"
VESSEL_DATABASE_VERSION="${VESSEL_DATABASE_VERSION:-v0.1.3}"
HARBOUR_EDITOR_VERSION="${HARBOUR_EDITOR_VERSION:-v2.0.20}"
VESSEL_SIMULATOR_VERSION="${VESSEL_SIMULATOR_VERSION:-v1.0.10}"
SELF_TRACK_SIMULATOR_VERSION="${SELF_TRACK_SIMULATOR_VERSION:-v0.1.1}"
PI_CONTROLLER_VERSION="${PI_CONTROLLER_VERSION:-v0.1.0}"
