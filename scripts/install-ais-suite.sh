...
AIS_PLUS_VERSION="${AIS_PLUS_VERSION:-v7.0.0}"
AIS_PLUS_AUDIO_VERSION="${AIS_PLUS_AUDIO_VERSION:-v1.0.0}"
AIS_PLUS_COMPANION_VERSION="${AIS_PLUS_COMPANION_VERSION:-v2.0.0}"
AIS_PLUS_APPLE_WATCH_VERSION="${AIS_PLUS_APPLE_WATCH_VERSION:-v1.0.0}"
CAPTURE_PLUS_VERSION="${CAPTURE_PLUS_VERSION:-v1.0.0}"
VESSEL_DATABASE_VERSION="${VESSEL_DATABASE_VERSION:-v1.0.0}"
HARBOUR_EDITOR_VERSION="${HARBOUR_EDITOR_VERSION:-v3.0.0}"
VESSEL_SIMULATOR_VERSION="${VESSEL_SIMULATOR_VERSION:-v2.1.0}"
SELF_TRACK_SIMULATOR_VERSION="${SELF_TRACK_SIMULATOR_VERSION:-v1.0.0}"
PI_CONTROLLER_VERSION="${PI_CONTROLLER_VERSION:-v1.0.0}"
