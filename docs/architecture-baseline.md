...
| `signalk-ais-plus-console` | `v0.3.8` | Watchkeeper Console; sailing workspace shell |
...
| `signalk-instruments-plus` | `v1.1.3` | Watchkeeper Instruments; display-only instrument application |
